...
namespace PetAdoptAPI.Controllers
{
    ...
    public class AdoptionRequestsController : ControllerBase
    {
        ...
        {
            if (id != adoptionRequest.RequestId)
            {
                return BadRequest();
            }
        ...
        public async Task<ActionResult<AdoptionRequest>> PostAdoptionRequest(AdoptionRequest adoptionRequest)
        {
            ...
            return CreatedAtAction("GetAdoptionRequest", new { id = adoptionRequest.RequestId }, adoptionRequest);
        }
        ...
        {
            return _context.AdoptionRequests.Any(e => e.RequestId == id);
        }
    }
}
